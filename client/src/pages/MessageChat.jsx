...
const MessageChat = () => {
  ...
  return (
    <div className="min-h-screen bg-[#161f32] text-white p-4 pt-0 pb-0">
      <div className="w-full mx-auto h-[100vh] flex flex-col bg-gray-800">
        {/* Header */}
        ...
        {/* Messages */}
        <div className="flex-1 overflow-y-auto p-5 px-10">
          {messages.length === 0 ? (
